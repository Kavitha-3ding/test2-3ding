...
// //     const handleOptionChange = (fileId, optionType, value) => {
// //         setFileOptions(prevState => {
// //             const updatedFileOptions = { ...prevState[fileId] };

// //             updatedFileOptions[optionType] = value;

// //             if (optionType === 'technology') {
// //                 const newTechnologyOptions = optionsData.technologyOptions[value];
// //                 updatedFileOptions.material = newTechnologyOptions.material[0] || '';
// //                 updatedFileOptions.color = newTechnologyOptions.color[0] || '';
// //                 updatedFileOptions.quality = newTechnologyOptions.quality[0] || '';
// //                 updatedFileOptions.density = newTechnologyOptions.density[0] || '';
// //             }

// //             return {
// //                 ...prevState,
// //                 [fileId]: updatedFileOptions,  // Updating options for specific file
// //             };
// //         });
// //     };

// //     // For setting options when new files are uploaded
// //     useEffect(() => {
...
// //                 files.forEach(file => {
// //                     if (!updatedOptions[file._id]) {
// //                         updatedOptions[file._id] = {
// //                             technology: 'FDM/FFF',
...
// //     // Calculation and other logic stays the same


// //     useEffect(() => {
// //         if (files.length > 0 && Object.keys(fileOptions).length > 0) {
// //             handleSubmitOrder();
// //         }
// //     }, [files, fileOptions]);
...
//     // Update file options for newly uploaded files
//     useEffect(() => {
//         const updateFileOptions = () => {
//             setFileOptions(prevState => {
//                 const updatedOptions = { ...prevState };
...
//             return {
//                 ...prevState,
//                 [fileId]: updatedFileOptions, // Ensure only this file's options are updated
//             };
//         });
//     };
...
//                     <tbody>
//                         {files.map((file, index) => (
//                             <tr key={file._id || index}> {/* Use a unique key, preferably `file._id`. Fallback to `index` if `_id` is not available */}
//                                 <td>{index + 1}</td>
//                                 <td className="py-2 text-start">{file.originalName}</td>
//                                 <td>
//                                     <select
