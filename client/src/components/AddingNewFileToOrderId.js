...
//              // Set shipping charges from the backend
      ...
      <div className="row">
        <div className="col-md-6 mt-5">
          ...
          <input
            ...
            className="form-control mb-3"
          />
          <FileUploader session={session} orderId={existingOrderId} onComplete={handleFileUploadComplete} />
        </div>
        <div className="col-md-4 offset-md-1 mt-5 pt-md-5">
          <OrderSummary
            orderId={existingOrderId}
                ...
                {files.map((file, index) => (
                  <tr key={file._id || index}>
                    ...
                    <td>
                      ...
                      >
                        {renderOptions(
                          optionsData.technologyOptions[fileOptions[file._id]?.technology || 'FDM/FFF']?.material || []
                        )}
                      </select>
                    </td>
                    <td>
                      ...
                      >
                        {renderOptions(
                          optionsData.technologyOptions[fileOptions[file._id]?.technology || 'FDM/FFF']?.color || []
                        )}
                      </select>
                    </td>
                    <td>
                      ...
                      >
                        {renderOptions(
                          optionsData.technologyOptions[fileOptions[file._id]?.technology || 'FDM/FFF']?.quality || []
                        )}
                      </select>
                    </td>
                    <td>
                      ...
                      >
                        {renderOptions(
                          optionsData.technologyOptions[fileOptions[file._id]?.technology || 'FDM/FFF']?.density || []
                        )}
                      </select>
                    </td>
                    <td className="col-md-1 text-center">
