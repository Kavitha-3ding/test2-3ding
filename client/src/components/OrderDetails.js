...
//             <p><strong>Lead Time:</strong> {`${order.leadTime} Days`}</p>
//           </div>
//           <div className='col-md-6 text-start'>
      ...
      <div className="">
        <div className="row my-5">
          <div className="col-md-6 text-start">
            ...
            <p>
              <strong>Lead Time:</strong> {`${order.leadTime} Days`}
            </p>
          </div>
          <div className="col-md-6 text-start">
            <p>
              ...
              <span className="fw-normal">
                (incl. Tax: ₹{gst} Shipping: ₹{shippingCharges})
              </span>
            </p>
            <button
            ...
            >
              {order.files.length === 0 ? 'Checkout' : 'Checkout'}
            </button>
          </div>
        </div>
        <div className="">
