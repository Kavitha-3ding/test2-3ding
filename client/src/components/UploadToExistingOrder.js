...
//     const handleOptionChange = (fileId, optionType, value) => {
//         setFileOptions(prevState => {
//             // Create a deep copy of the specific file's options
//             const updatedFileOptions = { ...prevState[fileId] };

//             // Update the specific option type
//             updatedFileOptions[optionType] = value;

//             // If the technology changes, reset dependent options
//             if (optionType === 'technology') {
//                 const newTechnologyOptions = optionsData.technologyOptions[value];
...
//             // Return the new state with the updated options for the specific file
//             return {
//                 ...prevState,
//                 [fileId]: updatedFileOptions,
//             };
//         });
//     };
...
//         const updateFileOptions = () => {
//             setFileOptions(prevState => {
//                 const updatedOptions = { ...prevState }; // Copy existing state

//                 files.forEach(file => {
//                     if (!updatedOptions[file._id]) {
//                         // Create unique options for each file
